...
public final class ClaimCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_((String)"claim").executes(ClaimCommands::help)).then(Commands.m_82127_((String)"help").executes(ClaimCommands::help))).then(Commands.m_82127_((String)"menu").executes(ClaimCommands::menu))).then(Commands.m_82127_((String)"info").executes(ClaimCommands::info))).then(Commands.m_82127_((String)"list").executes(ClaimCommands::list))).then(Commands.m_82127_((String)"remove").executes(ClaimCommands::remove))).then(((LiteralArgumentBuilder)Commands.m_82127_((String)"ban").requires(s -> s.m_6761_(2))).then(Commands.m_82129_((String)"jugador", (ArgumentType)EntityArgument.m_91466_()).executes(ClaimCommands::ban)))).then(((LiteralArgumentBuilder)Commands.m_82127_((String)"unban").requires(s -> s.m_6761_(2))).then(Commands.m_82129_((String)"jugador", (ArgumentType)EntityArgument.m_91466_()).executes(ClaimCommands::unban)))).then(((LiteralArgumentBuilder)Commands.m_82127_((String)"transfer").requires(s -> s.m_6761_(2))).then(Commands.m_82129_((String)"jugador", (ArgumentType)EntityArgument.m_91466_()).executes(ClaimCommands::transfer)))).then(((LiteralArgumentBuilder)Commands.m_82127_((String)"removemember").requires(s -> s.m_6761_(2))).then(Commands.m_82129_((String)"jugador", (ArgumentType)EntityArgument.m_91466_()).executes(ClaimCommands::removeMember))).then(Commands.m_82127_((String)"addmember").then(Commands.m_82129_((String)"jugador", (ArgumentType)StringArgumentType.word()).suggests(ONLINE_PLAYERS).executes(ClaimCommands::addMember))).then(Commands.m_82127_((String)"delmember").then(Commands.m_82129_((String)"jugador", (ArgumentType)StringArgumentType.word()).suggests(MEMBER_NAMES).executes(ClaimCommands::delMember))).then(Commands.m_82127_((String)"members").executes(ClaimCommands::members))).then(((LiteralArgumentBuilder)Commands.m_82127_((String)"give").requires(s -> s.m_6761_(2))).then(Commands.m_82129_((String)"jugador", (ArgumentType)EntityArgument.m_91470_()).then(Commands.m_82129_((String)"id", (ArgumentType)StringArgumentType.word()).suggests(CLAIMSTONE_IDS).executes(ClaimCommands::give))))).then(((LiteralArgumentBuilder)Commands.m_82127_((String)"clear").requires(s -> s.m_6761_(2))).then(Commands.m_82129_((String)"jugador", (ArgumentType)EntityArgument.m_91466_()).executes(ClaimCommands::clear))));
    }

    private static int help(CommandContext<CommandSourceStack> ctx) {
        boolean isOp = ((CommandSourceStack)ctx.getSource()).m_6761_(2);
        ((CommandSourceStack)ctx.getSource()).m_288197_(() -> {
            MutableComponent t = Component.m_237113_((String)"=== ClaimBlocks Comandos ===\n").m_130944_(new ChatFormatting[]{ChatFormatting.YELLOW, ChatFormatting.BOLD}).m_7220_((Component)Component.m_237113_((String)"/claim menu  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- abre el menu de la zona\n").m_130940_(ChatFormatting.GRAY)).m_7220_((Component)Component.m_237113_((String)"/claim info  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- info de la zona\n").m_130940_(ChatFormatting.GRAY)).m_7220_((Component)Component.m_237113_((String)"/claim list  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- lista tus zonas\n").m_130940_(ChatFormatting.GRAY)).m_7220_((Component)Component.m_237113_((String)"/claim remove  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- borra tu zona actual\n").m_130940_(ChatFormatting.GRAY)).m_7220_((Component)Component.m_237113_((String)"/claim addmember <jugador>  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- a\u00f1ade un miembro (aunque est\u00e9 offline)\n").m_130940_(ChatFormatting.GRAY)).m_7220_((Component)Component.m_237113_((String)"/claim delmember <jugador>  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- quita un miembro\n").m_130940_(ChatFormatting.GRAY)).m_7220_((Component)Component.m_237113_((String)"/claim members  ").m_130940_(ChatFormatting.AQUA)).m_7220_((Component)Component.m_237113_((String)"- lista los miembros de la zona\n").m_130940_(ChatFormatting.GRAY));
            if (isOp) {
                t.m_7220_((Component)Component.m_237113_((String)"\n--- Solo Operadores ---\n").m_130940_(ChatFormatting.RED)).m_7220_((Component)Component.m_237113_((String)"/claim give <jugador> <tier>\n").m_130940_(ChatFormatting.YELLOW)).m_7220_((Component)Component.m_237113_((String)"/claim clear <jugador>\n").m_130940_(ChatFormatting.YELLOW)).m_7220_((Component)Component.m_237113_((String)"/claim ban|unban <jugador>\n").m_130940_(ChatFormatting.YELLOW)).m_7220_((Component)Component.m_237113_((String)"/claim transfer <jugador>\n").m_130940_(ChatFormatting.YELLOW)).m_7220_((Component)Component.m_237113_((String)"/claim removemember <jugador>\n").m_130940_(ChatFormatting.YELLOW)).m_7220_((Component)Component.m_237113_((String)"/claimadmin").m_130940_(ChatFormatting.YELLOW));
            }
            return t;
        }, false);
        return 1;
