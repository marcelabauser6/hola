...
public class ClaimFlags {
    ...
    public boolean get(FlagId var1) {
        switch (var1) {
            case BUILDING: {
    ...
    public void set(FlagId var1, boolean var2) {
        switch (var1) {
            case BUILDING: {
    ...
    public void toggle(FlagId var1) {
        this.set(var1, !this.get(var1));
    }

    public static boolean isPaidOnly(FlagId var0) {
        return var0 == FlagId.EFFECT_REGEN || var0 == FlagId.EFFECT_RESIST || var0 == FlagId.EFFECT_SPEED || var0 == FlagId.ALLOW_FLIGHT;
    }
